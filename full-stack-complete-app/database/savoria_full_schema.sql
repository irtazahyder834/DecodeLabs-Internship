...
-- Schema: savoria_full_schema.sql
-- Engine: MySQL 8.0+ / MariaDB 10.4+
--
-- Combines the schemas from Projects 3 and 4 into a single
-- database powering the complete application: menu, orders,
-- users, authentication, and table reservations.
-- =========================================================

CREATE DATABASE IF NOT EXISTS savoria_app
